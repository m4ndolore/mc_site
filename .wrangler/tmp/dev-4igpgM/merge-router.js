...
// .wrangler/tmp/bundle-P4O1aF/checked-fetch.js
...
function createCookieHeader(name, value, maxAge, secure = true, domain = void 0) {
  const parts = [
    `${name}=${value}`,
    `Path=/`,
    `HttpOnly`,
...
// .wrangler/tmp/bundle-P4O1aF/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-P4O1aF/middleware-loader.entry.ts
