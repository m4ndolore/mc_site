  ...
  build: {
    rollupOptions: {
      input: {
        ...
        'signals-navy-airforce-restructure': resolve(__dirname, 'signals/navy-airforce-acquisition-restructure.html'),
        'signals-a10-disciplined-case': resolve(__dirname, 'signals/disciplined-case-for-the-a-10.html'),
