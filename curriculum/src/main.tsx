...
// Vite's base-path rewriting doesn't prefix them with /opportunities/.
// In production the browser is on mergecombinator.com, so "/" resolves
// to the main mc-site origin (not the opportunities Pages project).
function bootstrapSharedAssets(): void {
  ...
  // server's Vite dependency graph, not the opportunities server's.
...
createRoot(document.getElementById("root")!).render(
  <StrictMode>
    <BrowserRouter basename="/opportunities">
      <App />
    </BrowserRouter>
  </StrictMode>,
);
